...
$(function(){
    ...
    dataselect.push('DDC01','DDC02', 'DDC03','TDD01','TDD02','TDD03')
    ...
    $( "#termStart" ).change(function(){
        ...
        year_end = endday.getFullYear(); // 년도
        month_end = ('0'+ (endday.getMonth() + 1)).slice(-2);  // 월
        date_end = ('0' + endday.getDate()).slice(-2);
        termend = year_end+'-'+month_end+'-'+date_end
...
function selectgraph(){
        ...
        success : function(json) {
            ...
            for(var i = 0; i < edit_data.length; i++){
                ...
                if(graphlabel.indexOf(edit_data[i].monitoring_date) == -1 ){
                    ...
                    data_E_TDD01.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_N_TDD01.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_U_TDD01.push({'x': edit_data[i].monitoring_date, 'y': null})

                    data_E_TDD02.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_N_TDD02.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_U_TDD02.push({'x': edit_data[i].monitoring_date, 'y': null})

                    data_E_TDD03.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_N_TDD03.push({'x': edit_data[i].monitoring_date, 'y': null})
                    data_U_TDD03.push({'x': edit_data[i].monitoring_date, 'y': null})
                ...
                for(let i=0; i < edit_data.length; i++){
                    ...
                    if(graphlabel[j] == edit_data[i].monitoring_date){
                        ...
                        if(edit_data[i].monitoring_udp_port == '65001'){       
                            ...
                            if(dataselect.indexOf('DDC01') != -1 && edit_data[i].monitoring_fix == "1.00000" ){
                                if(idx != -1){
                            ...
                            }else if(dataselect.indexOf('TDD01') != -1 && edit_data[i].monitoring_fix == "0.00000" ){
                                // console.log("!!")
                                if(idx != -1){
                                    // console.log("222")
                                    data_E.push(edit_data[i].monitoring_E)
                                    ...
                                    data_E_TDD01[idx].y = edit_data[i].monitoring_E
                                    data_N_TDD01[idx].y = edit_data[i].monitoring_N
                                    data_U_TDD01[idx].y = edit_data[i].monitoring_U
                            ...
                            if(dataselect.indexOf('DDC02') != -1 && edit_data[i].monitoring_fix == "1.00000" ){
                                if(idx != -1){
                                    data_E.push(edit_data[i].monitoring_E)
                                    data_N.push(edit_data[i].monitoring_N)
                                    data_U.push(edit_data[i].monitoring_U)
                            ...
                            }else if(dataselect.indexOf('TDD02') != -1 && edit_data[i].monitoring_fix == "0.00000" ){
                                // console.log("!!")
                                if(idx != -1){
                                    data_E.push(edit_data[i].monitoring_E)
                                    data_N.push(edit_data[i].monitoring_N)
                                    ...
                                    // console.log("222")
                                    data_E_TDD02[idx].y = edit_data[i].monitoring_E
                                    data_N_TDD02[idx].y = edit_data[i].monitoring_N
                                    data_U_TDD02[idx].y = edit_data[i].monitoring_U
                            ...
                            }else if(dataselect.indexOf('TDD03') != -1 && edit_data[i].monitoring_fix == "0.00000" ){
                                // console.log("!!")
                                if(idx != -1){
                                    data_E.push(edit_data[i].monitoring_E)
                                    data_N.push(edit_data[i].monitoring_N)
                                    ...
                                    // console.log("222")
                                    data_E_TDD03[idx].y = edit_data[i].monitoring_E
                                    data_N_TDD03[idx].y = edit_data[i].monitoring_N
                                    data_U_TDD03[idx].y = edit_data[i].monitoring_U
    ...
    if( dataselect.indexOf('TDD03') != '-1'){
        datasets_E.push({
            label: 'UDP port1',
            backgroundColor: '#FFB4FF', 
            borderColor: '#FFB4FF', 
            data: data_E_TDD03,
            borderWidth:1,
            spanGaps : true 
