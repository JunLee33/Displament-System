...
class stationmap(Resource):
    ...
    def get (self):
        ...
        stationlist = [dict(r) for r in stationModel.monitoring_lo_st_station_id(project_id)]
...
class stationmonitoring(Resource):
    ...
    def post(self):
        ...
        for i in range(len(udp) // 5):
            if(len(udp_list) == 0):
                if udp[i*5:i*5+5] == 'DDC01':
                    ...
                    udp_list += "'65005'"
                    fix_list += "'1', '0'"
                elif udp[i*5:i*5+5] == 'TDD01':
                    udp_list += "'65001'"
                    fix_list += "'0'"
                elif udp[i*5:i*5+5] == 'TDD02':
                    udp_list += "'65003'"
                    fix_list += "'0'"
                elif udp[i*5:i*5+5] == 'TDD03':
                    udp_list += "'65005'"
                    fix_list += "'0'"
            else:
                if udp[i*5:i*5+5] == 'DDC01':
        ...
        param = (station_id, startdate, enddate, ratedate, udp_list, fix_list)
